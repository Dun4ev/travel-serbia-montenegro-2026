...
const highlights: Highlight[] = [
  { place: "Златибор", tag: "06-08 августа · 2 ночи", image: "/images/zlatibor.jpg", credit: "Grati / CC0", lead: "Главное - Gold Gondola. Если канатная дорога закрыта или захочется заменить ее, соберите спокойную дугу из двух точек, а не пытайтесь взять все три.", picks: [
    ["Šumatno brdo", "дополнительно вечером", "Легкая маркированная прогулка к мемориалу и панораме: около 2,3 км в одну сторону и 90 м набора."],
...
const locationGuides: Record<string, { tip: string; source: string; sourceLabel: string }> = {
  ...
  "sumatno-brdo": { tip: "Выбирайте один вечер и выходите только при достаточном запасе света. Маркированный маршрут от Kraljev trg занимает около 1,5-2 часов туда и обратно; координата показывает памятник, а не парковку.", source: "https://www.zlatibor.org.rs/sr/sta-raditi/pesacke-staze/Pe%C5%A1a%C4%8Dke-staze/", sourceLabel: "Пешеходные маршруты Златибора" },
